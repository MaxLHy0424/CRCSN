...
**最新发行版: v5.6.2.**\
**[更新日志](https://github.com/MaxLHy0424/CRCSN/releases/tag/v5.6.2) | [直链下载](https://github.com/MaxLHy0424/CRCSN/releases/download/v5.6.2/CRCSN-v5.6.2-Stable.7z)**
...
位于 "快捷操作" 区域下方. 如果 `[破解]` 和 `[恢复]` 下输出的文本为 `(i) 权限不足.`, 请以管理员权限重新启动软件.
