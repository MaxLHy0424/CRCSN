...
**最新发行版: v5.6.6.**\
**[更新日志](https://github.com/MaxLHy0424/CRCSN/releases/tag/v5.6.6) | [直链下载](https://github.com/MaxLHy0424/CRCSN/releases/download/v5.6.6/CRCSN.7z)**
...
> [!TIP]
> 启动命令提示符后, 可以使用命令 `mode con cols=行数 lines=列数` 调整窗口大小. 退出命令提示符后, 将会重置窗口属性.
