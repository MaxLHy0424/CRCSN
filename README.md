...
建议先关闭操作系统上已安装的所有防病毒软件, 以免 CRCSN 的操作被拦截.
...
1. 软件仅为 Windows 8 / 8.1 / 10 / 11 提供适配支持, Windows 7 及以下的 Windows 操作系统可使用软件, 但不会专门适配.
...
请从 GitHub 下载本仓库的压缩包文件, 解压, 将 `DLL` 文件夹下的文件复制进 CRCSN 主程序 (`main.exe`) 所在的文件夹, 具体文件树可参考下方:
