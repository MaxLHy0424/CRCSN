...
| CRCSN 5 | [v5.11.1](https://github.com/MaxLHy0424/CRCSN/releases/tag/v5.11.1)            | ❌ 停止更新 | 2024/08/25 ~ 2024/12/31 |
| CRCSN 6 | 🔒 暂未推出                                                                     | 🛠️ 正在开发 | 暂未确定                |
...
配置文件中标签 `[ customized_rules_execs ]` 到下一个标签的部分, 每个项目保留文件扩展名.
...
配置文件中标签 `[ customized_rules_servs ]` 到下一个标签的部分.
