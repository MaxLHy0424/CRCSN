...
bin/release/CRCSN-i686-msvcrt.exe: src/*.cpp src/*.hpp bin/info-i686.obj
	$(msys2)\\mingw32\\bin\\$(cc) src/*.cpp bin/info-i686.obj $(def) $(args_release) -o $@
bin/release/CRCSN-x86_64-ucrt.exe: src/*.cpp src/*.hpp bin/info-x86_64.obj
