...
配置文件中标签 `[ customized_rules_executables ]` 到下一个标签的部分, 每个项目保留文件扩展名.
...
配置文件中标签 `[ customized_rules_services ]` 到下一个标签的部分.
...
可尝试启用 "修复运行环境", 详见 [3.2.3 选项分类: 其他](#323-选项分类-其他).
